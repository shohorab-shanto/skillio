    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-600">{{ __('trans.total_courses') }}</p>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-600">{{ __('trans.approved') }}</p>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-600">{{ __('trans.pending') }}</p>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-600">{{ __('trans.rejected') }}</p>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-600">{{ __('trans.enrolled_students') }}</p>
            ...
            <div class="flex-1 min-w-64">
                <div class="relative">
                    ...
                    <input type="text" name="search" value="{{ $request->search }}" 
                           ...
                           placeholder="{{ __('trans.search_courses_placeholder') }}">
                </div>
            </div>
            ...
            <div class="p-6 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    <h2 class="text-lg font-semibold text-gray-900">
                        {{ __('trans.your_courses') }}
                        @if($request->status)
                            <span class="text-sm font-normal text-gray-500">({{ ucfirst($request->status) }} {{ __('trans.courses') }})</span>
                        @endif
                        @if($request->search)
                    ...
                    <div class="text-sm text-gray-500">
                        {{ __('trans.showing') }} {{ $courses->firstItem() ?? 0 }}-{{ $courses->lastItem() ?? 0 }} {{ __('trans.of') }} {{ $courses->total() }} {{ __('trans.courses') }}
                    </div>
                </div>
            </div>
                                ...
                                <div class="flex items-center justify-between mb-3">
                                    <div class="flex items-center text-yellow-400">
                                        ...
                                        <span class="ml-1 text-sm text-gray-500">
                                            ({{ $course->reviews->count() }} {{ __('trans.reviews') }})
                                        </span>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        @if($course->discount > 0)
                                            <span class="text-lg font-bold text-gray-900">
                                                {{ $currencySymbol }}{{ number_format($course->price * (1 - $course->discount / 100), 2) }}
                                            </span>
            ...
            <div class="text-center py-12">
                ...
                <h3 class="text-lg font-medium text-gray-900 mb-2">
                    @if($request->search || $request->status)
                        {{ __('trans.no_courses_found') }}
                    @else
                        {{ __('trans.no_courses_yet') }}
                    @endif
                </h3>
                <p class="text-gray-500 mb-6">
                    ...
                    @else
                        {{ __('trans.start_creating_courses') }}
                    @endif
                </p>
                ...
                @else
                    <a href="{{ route('mentor.courses.create') }}" class="bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg font-medium transition-colors">
                        <i class="fa-solid fa-plus mr-2"></i>
                        {{ __('trans.create_your_first_course') }}
                    </a>
                @endif
            </div>
        @endif
