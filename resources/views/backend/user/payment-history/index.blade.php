...
<div class="container">
    ...
    <div class="bg-white rounded-lg shadow mb-6">
        <div class="p-4">
            ...
            <!-- Search Bar -->
            <div class="w-full">
                <form method="GET" action="{{ route('user.payments') }}">
                    <div class="relative">
                        ...
                        <input 
                            ...
                            class="w-full lg:w-48 pl-8 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all duration-300 text-sm"
                        >
                    </div>
                </form>
            </div>
            ...
            <table class="w-full">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-sm font-medium text-gray-500 tracking-wider">{{ __('trans.paid_amount') }}</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($payments as $payment)
                        @php
                            ...
                            $mentorName = null;
                            if ($enrollable) {
                                if ($enrollable->mentor) {
                                    // For Course: mentor is User, for SessionBooking: mentor is Mentor
                                    if (method_exists($enrollable->mentor, 'user')) {
                ...
                <div class="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                    <div class="flex items-start justify-between mb-3">
                        ...
                        <div class="text-right">
                            <p class="text-lg font-bold text-green-600">${{ number_format($payment->gross_amount, 2) }}</p>
                            @if($payment->transaction_status == 'completed')
