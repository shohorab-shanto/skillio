<section id="new-courses" class="bg-gray-50">
    <div class="max-w-[1400px] mx-auto px-6">
        <x-section-header 
            title="{{ __('trans.explore_new_courses') }}"
            subtitle="{{ __('trans.discover_latest_courses_from_experts') }}"
            class="mb-8"
        />
        ...
        @empty
            <div class="col-span-full text-center py-12">
                <div class="text-gray-500">
                    ...
                    <h3 class="text-lg font-medium text-gray-900 mb-2">{{ __('trans.no_new_courses_available') }}</h3>
                    <p class="text-gray-600">{{ __('trans.working_on_adding_more_courses') }}</p>
                </div>
            </div>
        @endforelse
        </div>
