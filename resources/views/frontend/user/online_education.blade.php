...
@section('title', 'Online Education')
@section('meta_description', 'Explore online education options on Skillio.')
@section('meta_keywords', 'online, education, Skillio, onboarding')
            ...
            <div class="w-full flex flex-col md:flex-row gap-4 mb-8">
                <label class="flex-1 cursor-pointer group">
                    ...
                    <div class="flex flex-row items-center border-2 border-transparent peer-checked:border-purple-600 rounded-xl bg-white px-6 py-5 transition-all duration-200 shadow-sm peer-checked:shadow-lg hover:border-purple-400">
                        ...
                        <div>
                            <span class="font-semibold text-base text-gray-900 mb-1 block">A course from a mentor</span>
                            <span class="text-sm text-gray-500 text-left block">Learn through a guided mentor</span>
                        </div>
                    </div>
                </label>
                <label class="flex-1 cursor-pointer group">
                    ...
                    <div class="flex flex-row items-center border-2 border-transparent peer-checked:border-purple-600 rounded-xl bg-white px-6 py-5 transition-all duration-200 shadow-sm peer-checked:shadow-lg hover:border-purple-400">
                        ...
                        <div>
                            <span class="font-semibold text-base text-gray-900 mb-1 block">One-on-one mentoring</span>
                            <span class="text-sm text-gray-500 text-left block">Get direct support from a mentor.</span>
                        </div>
                    </div>
                </label>
                <label class="flex-1 cursor-pointer group">
                    ...
                    <div class="flex flex-row items-center border-2 border-transparent peer-checked:border-purple-600 rounded-xl bg-white px-6 py-5 transition-all duration-200 shadow-sm peer-checked:shadow-lg hover:border-purple-400">
                        ...
                        <div>
                            <span class="font-semibold text-base text-gray-900 mb-1 block">Both combined</span>
                            <span class="text-sm text-gray-500 text-left block">Access a course and direct mentoring.</span>
                        </div>
                    </div>
                </label>
            </div>
