<div class="bg-white rounded-xl shadow-md p-6 w-full max-w-sm hover:shadow-lg transition-shadow duration-300 flex flex-col h-full">
    ...
    <div class="mt-auto pt-4">
        <a href="{{ route('mentor.sessions', $mentor['id']) }}" class="block w-full bg-violet-600 hover:bg-violet-700 text-white px-5 py-3 rounded-lg text-sm font-semibold transition-colors duration-200 text-center">
