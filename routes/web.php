...
Route::middleware(['user_auth', 'set_locale'])->group(function () {
...
Route::middleware(['set_locale'])->group(function () {
    ...
    Route::match(['get', 'post'], '/login/apple/callback', [SocialAuthController::class, 'handleAppleCallback'])->name('login.apple.callback'); // Apple uses POST
});
